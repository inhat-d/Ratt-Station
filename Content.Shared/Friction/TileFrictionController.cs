    ...
    public sealed class TileFrictionController : VirtualController
    {
        ...
        public override void UpdateBeforeSolve(bool prediction, float frameTime)
        {
            ...
            foreach (var ent in PhysicsSystem.AwakeBodies)
            {
                ...
                {
                    // Pirate: temporary blockers such as ice cubes can validly use a dynamic mover body.
                    DebugTools.Assert(!_moverQuery.TryGetComponent(uid, out var mover) || !mover.CanMove,
