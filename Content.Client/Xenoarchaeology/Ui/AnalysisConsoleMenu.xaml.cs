...
using Content.Shared._Pirate.Xenoarchaeology.Systems; // Pirate - glimmer/artifact interactions
...
{
    private static readonly TimeSpan ExtractInfoDisplayForDuration = TimeSpan.FromSeconds(5); // Pirate - ported from DeltaV Acceleration PR #74
    ...
    private void StartExtract(BaseButton.ButtonEventArgs obj)
    {
        ...
        foreach (var node in nodes)
        {
            ...
            _extractionSum += pointValue; // Pirate
        }
        ...
        // Pirate - Begin: glimmer/artifact interactions (ported from DeltaV Acceleration PR #74)
